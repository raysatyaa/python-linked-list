    ...
    def print_inventory(self):
        ...
        if current is None:
            ...
            while current is not None:
                print(f"Nama: {current.item_name}, Tingkat Kepentingan: {current.importance_level}")
                current = current.next
...
# Nama: Buku Sihir, Tingkat Kepentingan: 2
# Nama: Potion Kesembuhan, Tingkat Kepentingan: 3
# Nama: Panah Sihir, Tingkat Kepentingan: 4
# Nama: Pedang Legendaris, Tingkat Kepentingan: 5
