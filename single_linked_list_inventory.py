    ...
    def print_inventory(self):
        ...
        if current is None:
            ...
            while current is not None:
                print(f"Nama Produk: {current.product_name}, Kode Produk: {current.product_code}, Jumlah Stok: {current.stock}")
                current = current.next
...
# Nama Produk: Keyboard, Kode Produk: KB001, Jumlah Stok: 10
# Nama Produk: Mouse, Kode Produk: MS001, Jumlah Stok: 15
# Nama Produk: Monitor, Kode Produk: MN001, Jumlah Stok: 5
